...
| `GET /api/v1/inbox` · `GET …/:id` · `POST …/:id/antwoorden` | De inbox van het personeelslid, met per item "wie ziet dit"; antwoorden op naam bij op-naam-vragen, zónder persoonskoppeling en zonder auditregel bij teambevragingen; "liever niet zeggen" is een geteld antwoord |
